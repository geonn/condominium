...
<html>
	...
	<body>
		...
		<div class="header">
	    	<table >
				<tr>
					<td rowspan="2" width="30px"><a href="<?= $this->config->item('admin_url') ?>"> <?= $this->config->item('img_logo') ?></a></td>
				</tr>
				<tr height="10px">
					<td>&nbsp; &nbsp; &nbsp;  </td>
					<td colspan="2" align='right' valign='bottom' style='padding-bottom:2px;'>	
						<span class='welcome_header'>Welcome <?= $this->authenticate->admin_username(); ?> </span>
	   					 <a class='logoutbutton' href="javascript:void(0);" onclick="confirmLogout();">Logout</a>
					</td>
